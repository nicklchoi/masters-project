...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_learning-msg:<Num> is deprecated: use ros_learning-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_learning-msg:num-val is deprecated.  Use ros_learning-msg:num instead.")
  (num m))

(cl:ensure-generic-function 'fsr1-val :lambda-list '(m))
(cl:defmethod fsr1-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_learning-msg:fsr1-val is deprecated.  Use ros_learning-msg:fsr1 instead.")
  (fsr1 m))

(cl:ensure-generic-function 'fsr2-val :lambda-list '(m))
(cl:defmethod fsr2-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_learning-msg:fsr2-val is deprecated.  Use ros_learning-msg:fsr2 instead.")
  (fsr2 m))

(cl:ensure-generic-function 'fsr_raw-val :lambda-list '(m))
(cl:defmethod fsr_raw-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_learning-msg:fsr_raw-val is deprecated.  Use ros_learning-msg:fsr_raw instead.")
  (fsr_raw m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Num>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'fsr_raw))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Num>) istream)
  ...
  (cl:setf (cl:slot-value msg 'fsr_raw) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'fsr_raw)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Num>)))
  ...
  "3dbc71f4adf6d91823c26a117a2b6ba4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Num)))
  "Returns md5sum for a message object of type 'Num"
  "3dbc71f4adf6d91823c26a117a2b6ba4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Num>)))
  ...
  (cl:format cl:nil "int64 num~%int32 fsr1~%int32 fsr2~%int32[] fsr_raw~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Num)))
  "Returns full string definition for message of type 'Num"
  (cl:format cl:nil "int64 num~%int32 fsr1~%int32 fsr2~%int32[] fsr_raw~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Num>))
  (cl:+ 0
     ...
     4
     4
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'fsr_raw) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
