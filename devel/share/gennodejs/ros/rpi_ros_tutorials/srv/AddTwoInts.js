...
// (in-package rpi_ros_tutorials.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'rpi_ros_tutorials/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'rpi_ros_tutorials/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'rpi_ros_tutorials/AddTwoInts'; }
};
