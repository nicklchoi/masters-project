...
def fsr_detect():
    ...
    #pub.publish(str(fsr1.value)+ str(fsr2.value))
    a = Int32MultiArray()
    a.data = [fsr1.value,fsr2.value]
    pub.publish(a)
    rate.sleep()
    sleep(0.1)
...
if __name__ == '__main__':
    ...
    pub = rospy.Publisher('fsr_data', Int32MultiArray, queue_size=10)  # servo_angle topic
    rate = rospy.Rate(10)
...
# to plot rqt_plot fsr_data/data[0] fsr_data/data[1]
